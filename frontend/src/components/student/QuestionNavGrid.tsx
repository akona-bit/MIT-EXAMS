    ...
    <>
      ...
      {isDrawerOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-slate-900 rounded-t-2xl shadow-2xl max-h-[80vh] flex flex-col">
            {/* Drawer header */}
            ...
            {/* Legend */}
            <div className="flex items-center gap-3 px-4 py-2 text-xs font-medium text-slate-500">
