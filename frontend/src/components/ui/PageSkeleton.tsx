  ...
  return (
    <div className={cn('space-y-4', className)}>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 overflow-hidden">
        {/* Table header */}
        <div className="flex gap-4 px-6 py-4 border-b border-slate-100 dark:border-slate-700">
        ...
        {Array.from({ length: rows }).map((_, i) => (
          <div
            key={i}
            className="flex items-center gap-4 px-6 py-4 border-b border-slate-50 dark:border-slate-700/50 last:border-0"
